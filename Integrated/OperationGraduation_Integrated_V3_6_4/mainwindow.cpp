...
//    roomchild->setWindowModality(Qt::ApplicationModal);
    ...
    connect(roomchild->game->player,SIGNAL(playToStat(int,int,int,int,int,int,int)),statchild,SLOT(updateStats(int,int,int,int,int,int,int)));
    connect(roomchild->game->player,SIGNAL(playLvlUpdate(std::string,int,int,int)),statchild,SLOT(updateDisplay(std::string,int,int,int)));
