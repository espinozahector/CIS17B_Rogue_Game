...
class Player : public QObject, public QGraphicsPixmapItem, public Character
{
    ...
    signals:
        void playToStat(int, int, int);  //constant stat update for StatChild
        void playLvlUpdate(int, int, int);      //stat update for StatChild when levelling
