...
void Player::keyPressEvent(QKeyEvent *event)
{
    ...
    {
        if(pos().x() <=70 && pos().x() > 20 && pos().y() >= 230 && pos().y() <= 250)
        {
            setPos(x()-10,y());
            playerx--;
...
//            std::cout << pos().x() << " " << pos().y() << std::endl;
    ...
    {
        if(pos().x() >= 800 && pos().x() < 850 && pos().y() >= 230 && pos().y() <= 250)
        {
            setPos(x()+10,y());
            playerx++;
        }
...
//            std::cout << pos().x() << " " << pos().y() << std::endl;
    ...
    {
        if(pos().x() >= 410 && pos().x() <= 440 && pos().y() <= 60 && pos().y() >= 30)
        {
            setPos(x(),y()-10);
            playery++;
        }
...
//            std::cout << pos().x() << " " << pos().y() << std::endl;
    ...
    {
        if(pos().x() >= 410 && pos().x() <= 440 && pos().y() >= 430 && pos().y() < 460)
        {
            setPos(x(),y()+10);
            playery--;
