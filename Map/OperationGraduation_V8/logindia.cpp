...
//    submit->setEnabled(false);
    ...
    connect(submit, SIGNAL(clicked(bool)), this->parent()->parent()->parent()->parent(), SLOT(newGame()));
    ...
    connect(password, SIGNAL(textChanged(const QString &)),
            this, SLOT(enableSubmitButton()));
    //connect(exit, SIGNAL(clicked()), this->parent()->parent()->parent()->parent(), SLOT(close()));
